...
################################################################################
## Form generated from reading UI file 'text_setting.ui'
##
...
class Ui_text_setting(object):
    def setupUi(self, text_setting):
        if not text_setting.objectName():
            text_setting.setObjectName(u"text_setting")
        text_setting.resize(600, 631)
        text_setting.setMinimumSize(QSize(0, 0))
        text_setting.setMaximumSize(QSize(16777215, 16777215))
        text_setting.setStyleSheet(u"background-color: rgb(52, 53, 65);\n"
"	color: rgb(255, 255, 255);\n"
"")
        self.horizontalLayout_7 = QHBoxLayout(text_setting)
        ...
        self.widget_16 = QWidget(text_setting)
        self.widget_16.setObjectName(u"widget_16")
        self.widget_16.setMinimumSize(QSize(560, 0))
        self.widget_16.setMaximumSize(QSize(800, 16777215))
        ...
        self.label = QLabel(self.widget_16)
...
"}")
        ...
        self.txt_davinci = QPushButton(self.widget)
        self.txt_davinci.setObjectName(u"txt_davinci")
        self.txt_davinci.setMinimumSize(QSize(90, 60))
        self.txt_davinci.setStyleSheet(u"QPushButton{\n"
...
"}")
        self.txt_davinci.setCheckable(True)
        self.txt_davinci.setChecked(True)
        self.txt_davinci.setAutoExclusive(True)
        self.txt_davinci.setFlat(True)

        self.horizontalLayout.addWidget(self.txt_davinci)

        self.txt_curie = QPushButton(self.widget)
        self.txt_curie.setObjectName(u"txt_curie")
        self.txt_curie.setMinimumSize(QSize(90, 60))
        self.txt_curie.setStyleSheet(u"QPushButton{\n"
"	border: 1px solid rgb(62, 63, 75);\n"
"	background-color: rgb(62, 63, 75);\n"
"	border-radius: 4px;\n"
"}\n"
...
"	background-color: rgb(32, 33, 35);\n"
"}")
        self.txt_curie.setCheckable(True)
        self.txt_curie.setChecked(False)
        self.txt_curie.setAutoExclusive(True)
        self.txt_curie.setFlat(True)

        self.horizontalLayout.addWidget(self.txt_curie)

        self.txt_babbage = QPushButton(self.widget)
        self.txt_babbage.setObjectName(u"txt_babbage")
        self.txt_babbage.setMinimumSize(QSize(90, 60))
        self.txt_babbage.setStyleSheet(u"QPushButton{\n"
"	border: 1px solid rgb(62, 63, 75);\n"
"	background-color: rgb(62, 63, 75);\n"
"	border-radius: 4px;\n"
"}\n"
...
"	background-color: rgb(32, 33, 35);\n"
"}")
        self.txt_babbage.setCheckable(True)
        self.txt_babbage.setChecked(False)
        self.txt_babbage.setAutoExclusive(True)
        self.txt_babbage.setFlat(True)

        self.horizontalLayout.addWidget(self.txt_babbage)

        self.txt_ada = QPushButton(self.widget)
        self.txt_ada.setObjectName(u"txt_ada")
        self.txt_ada.setMinimumSize(QSize(90, 60))
        self.txt_ada.setStyleSheet(u"QPushButton{\n"
"	border: 1px solid rgb(62, 63, 75);\n"
"	background-color: rgb(62, 63, 75);\n"
"	border-radius: 4px;\n"
"}\n"
...
"	background-color: rgb(32, 33, 35);\n"
"}")
        self.txt_ada.setCheckable(True)
        self.txt_ada.setChecked(False)
        self.txt_ada.setAutoExclusive(True)
        self.txt_ada.setFlat(True)

        self.horizontalLayout.addWidget(self.txt_ada)
...
"}")
        ...
        self.retranslateUi(text_setting)

        QMetaObject.connectSlotsByName(text_setting)
    # setupUi

    def retranslateUi(self, text_setting):
        text_setting.setWindowTitle(QCoreApplication.translate("text_setting", u"Form", None))
        self.label.setText(QCoreApplication.translate("text_setting", u"\u6587\u672c\u751f\u6210", None))
        self.label_2.setText("")
        self.label_3.setText(QCoreApplication.translate("text_setting", u"\u6a21\u578b\u9009\u62e9", None))
        self.model_help.setText("")
        self.txt_davinci.setText(QCoreApplication.translate("text_setting", u"Davinci", None))
        self.txt_curie.setText(QCoreApplication.translate("text_setting", u"Curie", None))
        self.txt_babbage.setText(QCoreApplication.translate("text_setting", u"Babbage ", None))
        self.txt_ada.setText(QCoreApplication.translate("text_setting", u"Ada ", None))
        self.label_10.setText("")
        self.label_11.setText(QCoreApplication.translate("text_setting", u"\u6700\u5927token\u6570\uff1a", None))
        self.txt_max_token.setText(QCoreApplication.translate("text_setting", u"16", None))
        self.token_help.setText("")
        self.label_4.setText("")
        self.label_5.setText(QCoreApplication.translate("text_setting", u"\u91c7\u6837\u6e29\u5ea6", None))
        self.temperature_help.setText("")
        self.temperature.setText(QCoreApplication.translate("text_setting", u"0", None))
        self.label_12.setText(QCoreApplication.translate("text_setting", u"\u66f4\u7a33\u5b9a", None))
        self.label_13.setText(QCoreApplication.translate("text_setting", u"\u66f4\u521b\u610f", None))
        self.label_6.setText("")
        self.label_7.setText(QCoreApplication.translate("text_setting", u"\u9891\u7387\u60e9\u7f5a", None))
        self.frequency_help.setText("")
        self.frequency_penalty.setText(QCoreApplication.translate("text_setting", u"0", None))
        self.label_16.setText(QCoreApplication.translate("text_setting", u"\u66f4\u91cd\u590d", None))
        self.label_17.setText(QCoreApplication.translate("text_setting", u"\u66f4\u4e30\u5bcc", None))
        self.label_8.setText("")
        self.label_9.setText(QCoreApplication.translate("text_setting", u"\u5b58\u5728\u60e9\u7f5a", None))
        self.presence_help.setText("")
        self.presence_penalty.setText(QCoreApplication.translate("text_setting", u"0", None))
        self.label_14.setText(QCoreApplication.translate("text_setting", u"\u66f4\u805a\u7126", None))
        self.label_15.setText(QCoreApplication.translate("text_setting", u"\u66f4\u53d1\u6563", None))
    # retranslateUi
